...
[group navigation state-of-the-art report](/pages/group-navigation.html).
...
[Medhi Moussaïd Phd Thesis](href="http://mehdimoussaid.com/TheseMoussaid.pdf)
(in french) to see if the comparison work is done in it.
