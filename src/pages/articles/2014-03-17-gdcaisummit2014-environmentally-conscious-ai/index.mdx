...
[![GDC 2014 AI Summit - Environmentally Conscious AI: Improving Spatial Analysis
  and Reasoning](./environmentally-conscious-ai.jpeg)](https://www.gdcvault.com/play/1020571/Environmentally-Conscious-AI-Improving-Spatial)
...
[**Download the slides**](./gdcaisummit2014-environmentally-conscious-ai.pdf)

## The simplest trick in the book - Simple formation assignment
...
[**View on slideshare**](https://fr.slideshare.net/crowdscontrol/simple-formation-assignment-gdc-14-ai-summit) -
[**Download the slides**](./gdcaisummit2014-simple-formation-assignment.pdf)

<Pdf
  title="Simple formation assignment"
  src={props.data.simplest_trick_pdf.publicURL}
/>
...
[![GDC 2014 AI Summit - Turing Tantrums: AI Devs Rant!](./turing-tantrums.jpeg)](https://www.gdcvault.com/play/1020577/Turing-Tantrums-AI-Devs-Rant)

[**Watch on the GDC Vault**](https://www.gdcvault.com/play/1020577/Turing-Tantrums-AI-Devs-Rant)

export const pageQuery = graphql`
  query {
    simplest_trick_pdf: file(
      name: { eq: "gdcaisummit2014-simple-formation-assignment" }
    ) {
      publicURL
    }
  }
