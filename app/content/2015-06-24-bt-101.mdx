...
date: 2015-06-24
cover: /content/2015-06-24-bt-101/bt-101-cover.png
categories:
  - resume
  - other_publications
---

> This article was originally published on the original [craft ai](https://www.craft.ai) website, it was deleted a while ago and can only be accessed through the [internet archive](https://web.archive.org/web/20150703080948/http://www.craft.ai/blog/bt-101-behavior-trees-grammar-basics/).
>
> Here is a more accessible version, unfortunately, I couldn't retrieve all the original illustrations.
...
![The 4 different states of BT nodes: not executed, running, failure, success](/content/2015-06-24-bt-101/bt-node-states.jpg)
...
_I wasn't able to retrieve this illustration of a behavior tree sequence node._
...
_I wasn't able to retrieve this illustration of a behavior tree sequence traversal steps._
...
_I wasn't able to retrieve this illustration of a behavior tree selector node._
...
_I wasn't able to retrieve this illustration of a behavior tree selector traversal steps._
...
_I wasn't able to retrieve this illustration of a behavior tree condition node._
...
_I wasn't able to retrieve this illustration of a behavior tree action node._
