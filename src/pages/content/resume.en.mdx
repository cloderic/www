...
**industrialization of the initial crowd simulation academic prototype** where I
was in charge of the navigation (path finding & steering) module.
...
from GIS data as a part of a larger project orchestrated by Orange Labs. Our
toolchain was used to build virtual versions of Paris and Barcelona.
